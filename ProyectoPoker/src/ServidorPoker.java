...
//		else 
	...
	public class Jugador implements Runnable{
		...
		public void run() 
		{
			...
			try{
				System.out.println("holi"+contador1);
				System.out.println("holi"+contador2);
				...
				if(tipoJuego ==1)
				{
					for(int i = 0; i<7;i++)
					{
						...
						{
						auxTexas += Integer.toString(cartas[i].getNumero())+
								Integer.toString(cartas[i].getPalo());
						
						}
						else
							auxTexas += Integer.toString(0)+ Integer.toString(cartas[i].getNumero())+
							Integer.toString(cartas[i].getPalo());
							
						System.out.println(cartas[i].getNumero() + "  " + cartas[i].getPalo());
				...
				if(tipoJuego ==2)
				{
					for(int i = 0; i<5;i++)
					{
						if ((Integer.toString(cartas[i].getNumero())).length() == 2)
						{
						auxCubierto += Integer.toString(cartas[i].getNumero())+
								Integer.toString(cartas[i].getPalo());
						
						}
						else
							auxCubierto += Integer.toString(0)+ Integer.toString(cartas[i].getNumero())+
							Integer.toString(cartas[i].getPalo());
							
						System.out.println(cartas[i].getNumero() + "  " + cartas[i].getPalo());
						
						System.out.println(auxCubierto);
					}
						...
						if(entrada.hasNext())
							{
								...
								if(tipoJuego == 1)
								{
									...
									jugadaAux = Integer.parseInt(String.valueOf(auxTexas));
									this.setJugada(jugadaAux);
...
//									posY = Integer.parseInt(String.valueOf(auxTexas.charAt(auxTexas.length()-1)));
								...
								if(tipoJuego == 2)
								{
									...
									auxCubierto = entrada.nextLine();
									jugadaAux = Integer.parseInt(String.valueOf(auxTexas));
									this.setJugada(jugadaAux);
//									posX = Integer.parseInt(String.valueOf(auxCubierto.charAt(auxCubierto.length()-2)));
//									posY = Integer.parseInt(String.valueOf(auxCubierto.charAt(auxCubierto.length()-1)));
								}
							}
